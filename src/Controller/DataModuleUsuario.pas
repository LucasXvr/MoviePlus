...
begin
  ...
  begin
    ...
    // Se o filme já existe (contagem maior que 0), retorna True; caso contrário, retorna False
...
begin
  ...
  begin
    ...
    // Se o filme não existe (contagem igual a 0), retorna True; caso contrário, retorna False
    Result := qryFilmes.Fields[0].AsInteger = 0;
  end;
end;
...
begin
  ...
  begin
    ...
    // Verificar as credenciais de login do usuário
    ...
    Open; // Abrir a consulta para executar a consulta SELECT e recuperar os dados
